...
function dy = IRMA5a(t,y,Z,K,u,pend,tlast)
...
% or glucose)
dy(3,1) =(K(10)*alfa3+ (K(11)*(1-u)+u*(K(11)*K(23)) )  *(y(2).^4./(  (K(13)*(1-u)+u*(K(13)/K(25)) ).^4 +y(2).^4  .*( 1+(y(4).^4./(   (K(12)*(1-u)+u*(K(12)*K(24)) ).^4)  ))  )    ) -deg3*K(14)*y(3));
% GAL80 mRNA
dy(4,1) =(K(15)+K(16)*(y(3)/(K(17)+y(3)) )- K(18) *y(4) );
% ASH1 mRNA
dy(5,1) =(K(19)*alfa4+ K(20)*(y(3)/(K(21)+y(3)))-K(22)*deg4*y (5));
