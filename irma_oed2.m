% $Header: svn://.../trunk/AMIGO_R2012_cvodes/Examples/IRMA/irma_oed.m 2095 2015-09-15 08:23:21Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.model.n_par=25; %- ??do we need this? changing par to K
...
%=====================================
 ...
 inputs.exps.t_f{1}=2000;                               % Experiment duration
 ...
 inputs.exps.t_f{2}=2000;                               % Experiment duration
